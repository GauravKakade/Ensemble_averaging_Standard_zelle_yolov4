...
while True:
    ...
    for out in outsdepth:
        for detection in out:
            ...
            if confidence > 0.2:
                ...
                boxes_depth.append([x/1000, y/1000, ((x + w)/1000), ((y + h)/1000)])
    ...
    for out in outs:
        for detection in out:
            ...
            if confidence > 0.2:
                ...
                boxes_rgb.append([x/1000, y/1000, ((x + w)/1000), ((y + h)/1000)])
    ...
    elapsed_time = time.time() - starting_time
    boxes_list = [boxes_depth, boxes_rgb]
    #print(boxes_list)
